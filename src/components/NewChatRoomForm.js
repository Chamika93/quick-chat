...
const NewChatRoomForm = ({onClickHandler}) => {
  return (
    <div className='mt-6 flex flex-row'>
        ...
        <button onClick={onClickHandler} data-testid="createChatButton" className="mx-5 px-5 rounded-md bg-blue-600 hover:bg-blue-700 text-white"> Create Chat</button>
    </div>
  )
}
